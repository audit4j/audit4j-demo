...
public class CombinedConsoleAndFileAuditHandlerWithConfigFileTest 
	extends ScenarioTest<GivenSomeState, WhenSomeAction, ThenSomeOutcome> {
	
    @Rule
    public final SystemOutRule systemOutRule = new SystemOutRule().enableLog();
    
	private static final String FILE_NAME = "audit4j-file-console.conf.yml";
	...
	@Test
	public void combined_console_and_file_audit_handler_with_file_configuration_receiving_a_message_with_event_builder() throws IOException {

        given().audit4j_starting_with_the_configuration_defined_in_the_file_$_for_$(FILE_NAME, Arrays.asList("ConsoleAuditHandler","FileAuditHandler"));
	...
	@Test
	public void combined_console_and_file_audit_handler_with_file_configuration_receiving_a_message_with_audit_event() throws IOException {
	...
	@Test
	public void combined_console_and_file_audit_handler_with_file_configuration_receiving_a_message_with_event_builder_with_pause() throws IOException {
